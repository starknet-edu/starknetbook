...
<h3 align="center"> Overview <a href="https://docs.google.com/</h3>presentation/d/1-ykeFFRwI2JTIyXAKd2AmVSIUnbjPk7EdfpHxL3CxYs/edit?usp=sharing">(slides)</a><a href="https://www.youtube.com/watch?v=DrBJ9LWvsOQ">(video)</a></h3>
...
<h3 align="center"> Evolution of Data Security</h3>
<div align="center">
...
<p align="center">💡Let's replicate Alice's account on another computer💡</p>
After all how many big ACME magnets can there really be?
...
<br>
Once the distributed database is setup we now have "Fault Tolerance" for our valueble piece of data `alice_account: 5.00`. If someone accidently brings their big ACME magnet into one datacenter, we have our piece of data easily accesible on another. Blockchains are not the only systems that make trade-offs, so what did we give up for this new fault tolerance?
...
<p align="center">💡Let's replicate Alice's account on ANY computer💡</p>

### [Bitcoin](./bitcoin/README.md)
In order to avoid the delegation of trust as we do in traditional systems Bitcoin brings various computer science concepts together with [game theoretics](https://en.wikipedia.org/wiki/Game_theory) to create a truly peer-to-peer network. In this context we can think of it as a peer-to-peer distributed database.