...
<h2 align="center" id="starknet_contracts">Writing Cairo</h2>

### Add two numbers

We will create a function to add two numbers. The code is very simple but it will help us to better understand many concepts of Cairo.
