...
[NOTE]
====
Before diving in, make sure to check out the https://book.starknet.io/chapter_3/topology.html["Understanding Starknet: Sequencers, Provers, and Nodes"] chapter for a quick rundown of Starknet's architecture.
====
...
* https://github.com/lambdaclass/cairo_native[Cairo Native] stands out by converting Cairo's Sierra code to MLIR. See an example link:https://github.com/lambdaclass/cairo_native/blob/main/examples/erc20.rs[here].
