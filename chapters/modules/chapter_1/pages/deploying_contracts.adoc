...
We will learn more about account contracts and how to customize them in Chapter 3.
...
Before deploying this account contract, we need to fund it so it can pay for its deployment (this process is called counterfactual deployment and will be studied in Chapter 3).
...
In Chapter 3, we will learn how to create customized account contracts.
...
In Chapter 3, we will get deeper into what defines a class hash.
