...
Refer to the implemetation in  https://github.com/starknet-edu/starknetbook/blob/main/chapters/modules/chapter_5/pages/builtins/cairo/hash.cairo[builtins/cairo/hash.cairo] for an example using the `output`, `pedersen`, and `range_check` builtins.
